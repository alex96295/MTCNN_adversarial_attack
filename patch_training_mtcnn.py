...
class PatchTrainer(object):
    ...
    def __init__(self, mode):
        ...
        if use_cuda:
            ...
            self.patch_transformer = PatchTransformer_glasses().to(self.device)
            ...
            self.nps_calculator = NPSCalculator(self.config.printfile, self.config.patch_size_glasses).to(self.device)
    ...
    def train(self):
        ...
        destination_name = 'loss_tracking_glasses_max_400ep_allnets.txt'
        destination_name2 = 'loss_tracking_compact_batch_glasses_max_400ep_allnets.txt'
        destination_name3 = 'loss_tracking_compatc_epochs_glasses_max_400ep_all_nets.txt'

        destination_name = 'loss_tracking_mouth_max_400ep_all_nets.txt'
        destination_name2 = 'loss_tracking_compact_batch_glasses_max_400ep_all_nets.txt'
        destination_name3 = 'loss_tracking_compatc_epochs_glasses_max_400ep_all_nets.txt'
        ...
        adv_patch_cpu = choose_patch('glasses')
        ...
        for epoch in range(n_epochs):
            ...
            for i_batch, (img_batch, lab_batch) in enumerate(train_loader):
                ...
                with autograd.detect_anomaly():
                    ...
                    adv_batch = self.patch_transformer(adv_patch, lab_batch, img_size, one_zero_mask, loc='eyes', do_rotate=False, rand_loc=False, align_angle=True)
            ...
            if True:
                ...
                # plt.imshow(im)
                # plt.show()
                im.save("./saved_patches_mytrial/mtcnn_glasses_max_400ep_all_nets.jpg")
